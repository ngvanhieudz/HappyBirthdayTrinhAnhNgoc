...
text: "Hiếu vừa gửi bạn một món quà đặc biệt nhân ngày sinh nhật của bạn ", 
 imageUrl: "https://scontent.fhph1-2.fna.fbcdn.net/v/t1.0-9/33094499_2060117090906077_1605104543522095104_n.jpg?_nc_cat=0&_nc_eui2=AeGSVtuBmlI1D3ikfLa6o9Fb1X9xTv6Inht8CkZeJbRCN5Sf5v79o9ufsbu5HqcdYMcfpexjg1DqzHZaeIx-U_fI3WCe9_7Gp_ifXQ1R2N9DEw&oh=3fc571fa7d44c20c6e65a9b1aabb14ec&oe=5BB214FA",
...
swal({  
 title: "Nhập tên món quà nào đó ", 
  text: "Ánh Ngọc muốn nhận quà gì nào ? ",  
 type: "input",  
 showCancelButton: true,  
 closeOnConfirm: false,   
animation: "slide-from-top",  
...
if (inputValue === false) return false;   
  ...
  return false   }  
 swal("OK ! ", "Món quà : " + inputValue + " sẽ tặng cho Ánh Ngọc trong 10s nữa hãy đợi nhé, Chúc một ngày Sinh Nhật thật Vui Vẻ nhé ^^   ", "success"); });
